...
class IDQNAgent:
    def __init__(self, state_size, action_size, learning_rate=0.001, gamma=0.99, epsilon_start=1.0, epsilon_min=0.0, epsilon_decay=0.9995, decay_method='exponential'):
...
def train_idqn(num_episodes=10000, batch_size=32, update_freq=50, save_freq=500, 
               epsilon_start=1.0, epsilon_min=0.001, epsilon_decay=0.9995, 
