...
class MultiAgentGridEnv:
    ...
    def __init__(self, grid_file, coverage_radius, max_steps_per_episode, num_agents, initial_positions, reward_type='global'):
        ...
        Parameters:
        - grid_file (str): Path to the JSON file containing the 2D grid representation.
        - coverage_radius (int): The radius within which an agent can detect coverage.
        - max_steps_per_episode (int): The maximum number of steps allowed per episode.
        - num_agents (int): The number of agents in the environment.
        - initial_positions (list of tuples): A list of initial (x, y) positions for each agent.
        - reward_type (str, optional): Type of reward system ('global' by default).

        Attributes:
        - grid (numpy.ndarray): The loaded 2D grid representation of the environment.
        - grid_height (int): The height of the grid.
        - grid_width (int): The width of the grid.
        - coverage_radius (int): The radius within which an agent can detect coverage.
        - max_steps_per_episode (int): The maximum number of steps allowed in a single episode.
        - num_agents (int): The number of agents in the environment.
        - initial_positions (list of tuples): Initial positions of agents.
        - reward_type (str): The reward system ('global' as default)
        - obs_size (int): The size of the observation space for an agent.
        - nx (NetworkX module) 
    """
    ...
    def get_sensor_readings(self):
        ...
        for pos in self.agent_positions:
            ...
            reading = [
                ...
                1 or self.grid[y + 1, x] == 1 or (x, y + 1) in self.agent_positions else 0,  # left
                # right
